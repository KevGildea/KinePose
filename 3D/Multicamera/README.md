...
6. Optimise for minor refinement in camera parameters to ensure that keypoints triangulate well. Perhaps through minimising the distance between projected keypoint rays.
